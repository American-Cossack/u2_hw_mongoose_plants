...
// script that, once executed, connects to the Mongo database and creates 7 plants in the plants collection.
...
const main = async () => {
  ...
  // insert the objects from plants array into our Plant database
